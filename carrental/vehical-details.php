        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              <input type="date" id="datepicker" class="form-control" name="fromdate" required>
            </div>
						<p>To : </p>
            <div class="form-group">
              <input type="date" id="datepicker" class="form-control" name="todate" required>
            </div>
						<p>Message : </p>
            <div class="form-group">
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">RM<?php echo htmlentities($result->PricePerDay);?></p>
